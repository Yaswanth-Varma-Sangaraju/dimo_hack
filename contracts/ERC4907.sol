...
contract ERC4907 is IERC4907, ERC721URIStorage{
  ...
  constructor(string meomory name_, string memory symbol_) ERC721(name_, symbol_){}
  ...
  function _beforeTokenTransfer(from, address to, uint256 tokenId) internal virtual override {
